...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sensor.scale'
        db.delete_column(u'mapping_sensor', 'scale')

        # Adding field 'Sensor.shortcode'
        db.add_column(u'mapping_sensor', 'shortcode',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Imp.serial'
        db.add_column(u'mapping_imp', 'serial',
                      self.gf('django.db.models.fields.CharField')(default='deafult', unique=True, max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sensor.scale'
        db.add_column(u'mapping_sensor', 'scale',
                      self.gf('django.db.models.fields.CharField')(default='backwards', max_length=100),
                      keep_default=False)

        # Deleting field 'Sensor.shortcode'
        db.delete_column(u'mapping_sensor', 'shortcode')

        # Deleting field 'Imp.serial'
        db.delete_column(u'mapping_imp', 'serial')
